...
--
-- Host: db
-- Generation Time: Jul 11, 2018 at 11:26 AM
...
--
-- Table structure for table `folderassign_1`
--

CREATE TABLE `folderassign_1` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `folderassign_1`
--

INSERT INTO `folderassign_1` (`id`, `folder`, `content`, `type`) VALUES
(1, 1, 'bookmark', 0),
(2, 2, 'Vids', 0),
(3, 3, 'NewsSpeak', 0),
(4, 1, 'bookmark2', 0),
(5, 1, 'present', 0),
(6, 4, 'test1', 0),
(7, 1, 'folderinfolder', 1);

-- --------------------------------------------------------

--
-- Table structure for table `folderassign_2`
--

CREATE TABLE `folderassign_2` (
  `id` int(11) NOT NULL,
  `folder` int(11) NOT NULL,
  `content` varchar(50) NOT NULL,
...
--
-- Dumping data for table `folderassign_2`
--

INSERT INTO `folderassign_2` (`id`, `folder`, `content`, `type`) VALUES
(2, 1, 'infolderinfolder', 0);

-- --------------------------------------------------------

--
-- Table structure for table `folder_1`
--
...
--
-- Dumping data for table `folder_1`
--

INSERT INTO `folder_1` (`id`, `name`) VALUES
(1, 'Testfolder'),
(2, 'Video'),
(3, 'Newpaper'),
(4, 'test');
...
--
-- Table structure for table `folder_2`
--

CREATE TABLE `folder_2` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `folder_2`
--

INSERT INTO `folder_2` (`id`, `name`) VALUES
(1, 'folderinfolder');
...
--
-- Indexes for table `folderassign_1`
--
ALTER TABLE `folderassign_1`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `folderassign_2`
--
ALTER TABLE `folderassign_2`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `folder_1`
--
ALTER TABLE `folder_1`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `folder_2`
--
ALTER TABLE `folder_2`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `folderassign_1`
--
ALTER TABLE `folderassign_1`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `folderassign_2`
--
ALTER TABLE `folderassign_2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `folder_1`
--
ALTER TABLE `folder_1`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `folder_2`
--
ALTER TABLE `folder_2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
